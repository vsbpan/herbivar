...
system.time(
  sum(dalloT(x, lambda = 3, log = TRUE, by = 0.00001, parallel = TRUE, cores = 4))
)

# Compute the same expression without parallelization
system.time(
  sum(dalloT(x, lambda = 3, log = TRUE, by = 0.00001, parallel = FALSE))
)
